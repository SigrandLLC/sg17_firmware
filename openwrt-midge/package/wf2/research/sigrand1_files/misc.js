...
function openDeletePopup(win, itemToDelete, exturl) {
	...
	if (winl < 0) winl = 0;
	if (wint < 0) wint = 0;
	popup=win.open("/?controller=delete_popup&item=" + itemToDelete + "&popup=1&"+exturl, "popup", "width="+w+",height="+h+",top="+wint+",left="+winl+",modal=1,dialog=1,centerscreen=1,scrollbars=0,menubar=0,location=0,toolbar=0,dependent=1,status=0"); 
	popup.focus();
}
